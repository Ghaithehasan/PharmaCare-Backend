...
<style>
    ...
    .all-invoices-card .invoice-info {
        display: grid;
    ...
    <div class="col-xl-12">
        @if (session()->has('add_archive'))
            <div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-bottom: 20px;">
                ...
                <strong>نجح!</strong> {{ session('add_archive') }}
        ...
        @if($invoices->count() == 0)
            <div class="text-center py-5">
                ...
                <h4 class="mt-3 text-muted">لا توجد فواتير</h4>
                ...
                <div class="all-invoices-card">
                    <div class="invoice-header">
                        ...
                        @elseif($invoice->status == 'partially')
                            <span class="badge badge-partially status-badge">مدفوعة جزئيا</span>
                        @endif
                    </div>
