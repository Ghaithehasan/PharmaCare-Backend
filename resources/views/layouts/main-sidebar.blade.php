    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{ $supplier->contact_person_name }}</h4>
                    <span class="mb-0 text-muted">{{ $supplier->email }}</span>
                </div>
            </div>
        </div>
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard_page') }}"><svg
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ route('supplier.invoices.index') }}">قائمة الفواتير</a></li>



                            <li><a class="slide-item" href="{{ route('supplier.invoices.paid') }}">الفواتير المدفوعة</a>


                        </li>

                            <li><a class="slide-item" href="{{ route('supplier.invoices.unpaid') }}">الفواتير
                                    الغيرمدفوعة</a>
                            </li>

                            <li><a class="slide-item" href="{{ route('supplier.invoices.partially') }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>

                            <li><a class="slide-item" href="{{ route('supplier.invoices.show_archive') }}">ارشيف الفواتير</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices-reports')) }}">تقارير الفواتير</a>
                            </li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'custumer-Reborts')) }}">تقارير العملاء</a>
                            </li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ route('supplier.orders.show_all_order') }}">قائمة جميع الطلبات</a></li>

                            <li><a class="slide-item" href="{{ route('supplier.orders.index') }}">قائمة الطلبات المعلقة</a></li>

                            <li><a class="slide-item" href="{{ route('supplier.orders.accepted') }}">قائمة الطلبات المقبولة</a></li>

                            <li><a class="slide-item" href="{{ route('supplier.orders.show_canceled_orders') }}">قائمة الطلبات الملغية</a></li>

                            <li><a class="slide-item" href="{{ route('supplier.orders.show_completed_order') }}">قائمة الطلبات المكتملة</a></li>

                    </ul>
                </li>

                <li class="side-item side-item-category">قائمة المدفوعات</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ route('supplier.payments.all_payments') }}">قائمة المدفوعات</a></li>


                            <li><a class="slide-item" href="{{ route('supplier.payments.pending_payments') }}">قائمة المدفوعات المعلقة</a></li>

                            <li><a class="slide-item" href="{{ route('supplier.payments.confirmed_payments') }}">قائمة المدفوعات المقبولة</a></li>

                            <li><a class="slide-item" href="{{ route('supplier.payments.rejected_payments') }}">قائمة المدفوعات المرفوضة</a></li>
